...
function _tk_scripts() {
	...
	wp_enqueue_style( '_tk-bootstrap-css', THEME_DIR_URI . '/includes/aung_pyit_sone/bootstrap/dist/css/bootstrap.min.css');
	wp_enqueue_style( '_style-css', THEME_DIR_URI . '/includes/aung_pyit_sone/css/style.css');
	...
	// load bootstrap js
	wp_enqueue_script('_bootstrapjs', THEME_DIR_URI . '/includes/aung_pyit_sone/bootstrap/dist/js/bootstrap.bundle.min.js', array('jquery') );
	wp_enqueue_script('_app-js', THEME_DIR_URI . '/includes/aung_pyit_sone/js/app.js', array('jquery') );
